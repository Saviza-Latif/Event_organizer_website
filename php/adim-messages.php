...
<div class="review-container">
    ...
    <div class="review">
        <div class="navbar">
            <div class="navbarname">Messages</div>
        </div>
        <section class="review1">
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <a href="admin_messages.php?delete=<?php echo $fetch_message['id']; ?>" onclick="return confirm('delete this message?');" class="delete-btn brown-btn">delete message</a>
                </div>
                 <?php
                 };
                }else{
